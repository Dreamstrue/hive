...
<body>
    ...
    <div class="navbar navbar-default" role="navigation">
        ...
        <div class="navbar-inner">
            ...
            <!-- 20160909 yyf edit 注释掉  未发现有何用处<button type="button" class="navbar-toggle pull-left animated flip">
            ...
            <!-- 20190909 yyf edit 注释 主题切换功能 <div class="btn-group pull-right theme-container animated tada">
            ...
            <!--20160909 yyf edit 注释掉  菜单下拉选和搜索框 <ul class="collapse navbar-collapse nav navbar-nav top-menu">
